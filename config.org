...
** Agenda
   ...
   I've disabled this because of error: (void-function org-dynamic-block-define)
...
** Reference Management
  ...
  ; error Could not find package "ox-latex" in recipe repositories
